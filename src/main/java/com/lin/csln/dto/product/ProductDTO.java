...
public class ProductDTO implements Serializable {
    ...
    @Schema(description = "商品主图", example = "https://example.com/images/prod1.jpg")
    ...
    @Schema(description = "商品关联的颜色图片列表")
    private List<ProductColorImageDTO> colorImageList;

    @Schema(description = "商品关联的SKU列表")
