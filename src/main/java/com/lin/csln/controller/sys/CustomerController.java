...
public class CustomerController {
    ...
    @RequirePermission({PermissionGateEnum.CUSTOMER_LIST})
    ...
    @RequirePermission({PermissionGateEnum.CUSTOMER_VIEW})
    ...
    @RequirePermission({PermissionGateEnum.CUSTOMER_UPDATE})
    @OperationLog(
            module = OperationLogModuleEnum.CUSTOMER,
