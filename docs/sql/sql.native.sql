...
create table csln_erp.after_sale_item
(
    id                  bigint auto_increment comment '主键'
        primary key,
    as_id               bigint                             not null comment '退换货单ID',
    order_item_id       bigint                             not null comment '原订单明细ID',
    product_id          bigint                             not null comment '商品ID',
    color_id            bigint                             not null comment '颜色ID',
    real_sku_id         bigint                             not null comment '原真实SKU（参考）',
    ship_sku_id         bigint                             not null comment '原发货SKU',
    qty                 int                                not null comment '退货/换货数量',
    op_type             tinyint                            not null comment '1退货 2换货',
    new_sku_id          bigint                             null comment '换货目标SKU',
    new_qty             int      default 0                 null comment '换货发出数量',
    warehouse_id        bigint                             not null comment '仓库ID',
    confirm_real_sku_id bigint                             null comment '仓管确认的真实SKU（最终入库用）',
    create_time         datetime default CURRENT_TIMESTAMP null comment '创建时间'
)
    comment '退换货明细' charset = utf8mb4;

create table csln_erp.color
(
    id   bigint auto_increment comment '主键'
        primary key,
...
create table csln_erp.customer
(
    id          bigint auto_increment comment '主键'
        primary key,
    name        varchar(100)                       not null comment '客户名称',
    phone       varchar(20)                        null comment '电话',
    level_id    bigint                             null comment '等级ID',
...
create table csln_erp.customer_level
(
    id         bigint auto_increment comment '主键'
        primary key,
...
create table csln_erp.delivery_note
(
    id               bigint auto_increment comment '主键'
        primary key,
    delivery_no      varchar(50)  not null comment '发货单号',
    sub_order_id     bigint       not null comment '子单ID',
    ...
    send_user_id     bigint       null comment '发货人',
    constraint uk_delivery_no
        unique (delivery_no)
)
    comment '发货单' charset = utf8mb4;

create table csln_erp.order_change_log
(
    id              bigint auto_increment comment '主键'
        primary key,
    master_id       bigint                             not null comment '母单ID',
    sub_id          bigint                             null comment '子单ID',
    before_content  text                               null comment '修改前',
    after_content   text                               null comment '修改后',
    apply_user_id   bigint                             null comment '申请人',
    approve_user_id bigint                             null comment '审批人',
...
create table csln_erp.order_help_send
(
    id           bigint auto_increment comment '主键'
        primary key,
    order_sub_id bigint            not null comment '子单ID',
    from_ware_id bigint            not null comment '代发仓库',
    status       tinyint default 0 null comment '状态'
)
    comment '协发单' charset = utf8mb4;

create table csln_erp.order_item
(
    id         bigint auto_increment comment '主键'
        primary key,
    master_id  bigint         not null comment '母单ID',
    sub_id     bigint         not null comment '子单ID',
...
create table csln_erp.order_master
(
    id               bigint auto_increment comment '主键'
        primary key,
    ...
    audit_user_id    bigint                                   null comment '审核人',
    audit_time       datetime                                 null comment '审核时间',
    sales_user_id    bigint                                   not null comment '业绩归属销售ID',
    delivery_type    tinyint                                  null comment '1快递 2司机 3自提',
    express_no       varchar(100)                             null comment '快递单号',
    driver_phone     varchar(20)                              null comment '司机/自提手机号',
    ...
    create_user_id   bigint                                   not null comment '开单人',
    remark           varchar(255)                             null comment '备注',
...
create table csln_erp.order_replace_detail
(
    id            bigint auto_increment comment '主键'
        primary key,
    ...
    product_id    bigint                             not null comment '商品ID',
    color_id      bigint                             not null comment '颜色ID',
    target_sku_id bigint                             not null comment '客户要的SKU（目标码）',
    real_sku_id   bigint                             not null comment '实际发货SKU（真实库存码）',
...
create index idx_order_item
    on csln_erp.order_replace_detail (order_item_id);

create table csln_erp.order_sub
(
    id                bigint auto_increment comment '主键'
        primary key,
    ...
    picker_user_id    bigint                      null comment '配货员',
    remark            varchar(255)                null comment '备注',
...
(
    ...
    remark         varchar(255)                       null comment '备注',
    create_user_id bigint                             null comment '操作人',
...
create table csln_erp.price_customer
(
    id          bigint auto_increment comment '主键'
        primary key,
    product_id  bigint         not null comment '商品ID',
...
create table csln_erp.price_last
(
    id          bigint auto_increment comment '主键'
        primary key,
    product_id  bigint                             not null comment '商品ID',
...
create table csln_erp.price_level
(
    id         bigint auto_increment comment '主键'
        primary key,
    product_id bigint         not null comment '商品ID',
...
(
    ...
    main_image_id   bigint                                   null comment '商品主图文件ID（关联file表）',
    status          tinyint        default 1                 null comment '状态',
    create_time     datetime       default CURRENT_TIMESTAMP null comment '创建时间',
...
create table csln_erp.product_color_image
(
    id            bigint auto_increment comment '主键'
        primary key,
    product_id    bigint                             not null comment '商品ID',
    color_id      bigint                             not null comment '颜色ID',
    color_file_id bigint                             null comment '颜色图片文件ID（关联file表）',
    create_time   datetime default CURRENT_TIMESTAMP null comment '创建时间',
    constraint uk_prod_color
        unique (product_id, color_id)
)
    comment '商品颜色图片表' charset = utf8mb4;

create table csln_erp.product_sku
(
    id         bigint auto_increment comment '主键'
        primary key,
    product_id bigint       not null comment '商品ID',
...
create table csln_erp.purchase_in
(
    id             bigint auto_increment comment '主键'
        primary key,
    in_no          varchar(50)                        not null comment '入库单号',
    purchase_id    bigint                             null comment '来源采购单',
...
create table csln_erp.purchase_in_item
(
    id     bigint auto_increment comment '主键'
        primary key,
...
create table csln_erp.purchase_order
(
    id             bigint auto_increment comment '主键'
        primary key,
    ...
    create_user_id bigint                                   null comment '制单人',
...
create table csln_erp.purchase_order_item
(
    id          bigint auto_increment comment '主键'
        primary key,
...
create table csln_erp.purchase_return
(
    id           bigint auto_increment comment '主键'
        primary key,
    ...
    supplier_id  bigint                             not null comment '供应商ID',
    warehouse_id bigint                             not null comment '退货仓库',
    status       tinyint  default 0                 null comment '0待审核 1已审核',
...
create table csln_erp.purchase_return_item
(
    id        bigint auto_increment comment '主键'
        primary key,
...
create table csln_erp.sales_statistics
(
    id            bigint auto_increment comment '主键'
        primary key,
    ...
    shop_id       bigint                      not null comment '门店ID',
    sales_user_id bigint                      not null comment '销售ID',
...
create table csln_erp.shop
(
    id                   bigint auto_increment comment '主键'
        primary key,
    shop_name            varchar(100)                       not null comment '门店名称',
    manager_user_id      bigint                             null comment '店长ID',
    default_warehouse_id bigint                             null comment '默认送单仓',
...
create table csln_erp.stock_lock_log
(
    id           bigint auto_increment comment '主键'
        primary key,
    warehouse_id bigint                             not null comment '仓库ID',
...
create table csln_erp.stock_recovery
(
    id                bigint auto_increment comment '主键'
        primary key,
    sku_id            bigint            not null comment 'SKU_ID',
    ...
    used_sub_order_id bigint            null comment '占用子单ID',
    used_time         datetime          null comment '占用时间'
)
    comment '追回货表' charset = utf8mb4;

create table csln_erp.stock_transfer
(
    id             bigint auto_increment comment '主键'
        primary key,
    transfer_no    varchar(50)                        not null comment '调货单号',
    from_ware_id   bigint                             not null comment '调出仓',
    to_ware_id     bigint                             not null comment '调入仓',
...
create table csln_erp.stock_transfer_item
(
    id          bigint auto_increment comment '主键'
        primary key,
...
create table csln_erp.supplier
(
    id          bigint auto_increment comment '主键'
        primary key,
...
(
    ...
    before_data text                               null comment '修改前',
    after_data  text                               null comment '修改后',
    create_time datetime default CURRENT_TIMESTAMP null comment '操作时间'
)
    comment '系统操作日志' charset = utf8mb4;

create table csln_erp.sys_menu
(
    id          bigint auto_increment comment '主键'
        primary key,
    parent_id   bigint   default 0                 not null comment '父菜单ID，顶级菜单为0',
...
create table csln_erp.sys_permission
(
    id        bigint auto_increment comment '主键'
        primary key,
...
create table csln_erp.sys_role
(
    id        bigint auto_increment comment '主键'
        primary key,
...
create table csln_erp.sys_role_menu
(
    id          bigint auto_increment comment '主键'
        primary key,
...
create table csln_erp.sys_role_permission
(
    id      bigint auto_increment comment '主键'
        primary key,
    role_id bigint not null comment '角色ID',
...
create table csln_erp.sys_user
(
    id           bigint auto_increment comment '主键'
        primary key,
    ...
    phone        varchar(20)                        null comment '电话',
    shop_id      bigint                             null comment '所属门店ID',
    warehouse_id bigint                             null comment '所属仓库ID',
    status       tinyint  default 1                 not null comment '状态 1正常 0禁用',
    create_time  datetime default CURRENT_TIMESTAMP null comment '创建时间',
    update_time  datetime default CURRENT_TIMESTAMP null on update CURRENT_TIMESTAMP comment '更新时间'
)
...
create table csln_erp.sys_user_role
(
    id      bigint auto_increment comment '主键'
        primary key,
...
create table csln_erp.warehouse
(
    id              bigint auto_increment comment '主键'
        primary key,
    warehouse_name  varchar(100)                       not null comment '仓库名称',
    manager_user_id bigint                             null comment '仓管ID',
    address         varchar(255)                       null comment '地址',
    status          tinyint  default 1                 not null comment '状态',
    create_time     datetime default CURRENT_TIMESTAMP null comment '创建时间',
